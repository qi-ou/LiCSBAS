...
def plot_cum_grid(cum, titles, suptitle, png, downsample=10, vmin=-20, vmax=20):
    ...
    for i in np.arange(n_im):
        ...
        col = i % n_col
        print(i, row, col)
        im = ax[row, col].imshow(cum[i, ::downsample, ::downsample], vmin=vmin, vmax=vmax, cmap=SCM.roma.reversed())
